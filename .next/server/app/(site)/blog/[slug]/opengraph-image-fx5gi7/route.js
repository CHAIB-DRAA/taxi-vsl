...
`}(e)}))],v="edge",h={width:1200,height:630},f="image/png",b={Guide:"#8b5cf6",Hôpitaux:"#ef4444","Transport M\xe9dical":"#3b82f6",Trajets:"#22c55e","Courses Priv\xe9es":"#eab308",Villes:"#64748b"};async function q(){return g.map(e=>({slug:e.slug}))}function T({params:e}){var t;let o=(t=e.slug,g.find(e=>e.slug===t)),n=o?.title??"Taxi Conventionn\xe9 CPAM Toulouse",s=o?.category??"Guide",a=b[s]??"#3b82f6";return new c.E((0,d.jsxs)("div",{style:{background:"linear-gradient(135deg, #0f172a 0%, #1e2d4a 100%)",width:"100%",height:"100%",display:"flex",flexDirection:"column",justifyContent:"space-between",padding:"56px 72px",fontFamily:"system-ui, sans-serif"},children:[(0,d.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:16},children:[(0,d.jsx)("div",{style:{background:a,borderRadius:"8px",padding:"6px 16px",fontSize:13,fontWeight:800,color:"white",letterSpacing:"0.12em",textTransform:"uppercase",display:"flex"},children:s}),(0,d.jsx)("div",{style:{color:"#475569",fontSize:14,display:"flex"},children:"taxi-31-toulouse.fr"})]}),(0,d.jsx)("div",{style:{fontSize:n.length>60?40:48,fontWeight:900,color:"white",lineHeight:1.2,display:"flex",flex:1,alignItems:"center",padding:"24px 0"},children:n}),(0,d.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[(0,d.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:4},children:[(0,d.jsx)("div",{style:{fontSize:22,fontWeight:800,color:"#eab308",display:"flex"},children:"Occitanie M\xe9di Mobility"}),(0,d.jsx)("div",{style:{fontSize:15,color:"#64748b",display:"flex"},children:"Taxi conventionn\xe9 CPAM • Tiers payant int\xe9gral"})]}),(0,d.jsx)("div",{style:{background:"#eab308",borderRadius:"12px",padding:"10px 24px",fontSize:20,fontWeight:900,color:"#0f172a",display:"flex"},children:"07 72 33 98 92"})]})]}),{...h})}let C={...n},P=C.default,L=C.generateImageMetadata;if("function"!=typeof P)throw Error('Default export is missing in "/Users/mondz/Downloads/taxi-occitanie-project/src/app/(site)/blog/[slug]/opengraph-image.tsx"');async function A(e,t){let o;let{__metadata_id__:n,...s}=t.params||{},a=n?.[0],i=L?await L({params:s}):null;return i&&null==(o=i.find(e=>e.id.toString()===a)?.id)?new p.xk("Not Found",{status:404}):P({params:t.params?s:void 0,id:o})}let y=new r.AppRouteRouteModule({definition:{kind:u.x.APP_ROUTE,page:"/(site)/blog/[slug]/opengraph-image-fx5gi7/route",pathname:"/blog/[slug]/opengraph-image-fx5gi7",filename:"opengraph-image",bundlePath:"app/(site)/blog/[slug]/opengraph-image-fx5gi7/route"},resolvedPagePath:"next-metadata-route-loader?page=%2F(site)%2Fblog%2F%5Bslug%5D%2Fopengraph-image-fx5gi7%2Froute&filePath=%2FUsers%2Fmondz%2FDownloads%2Ftaxi-occitanie-project%2Fsrc%2Fapp%2F(site)%2Fblog%2F%5Bslug%5D%2Fopengraph-image.tsx&isDynamic=1!?__next_metadata_route__",nextConfigOutput:"",userland:s}),{requestAsyncStorage:z,staticGenerationAsyncStorage:M,serverHooks:S}=y,V="/(site)/blog/[slug]/opengraph-image-fx5gi7/route";function N(){return(0,l.XH)({serverHooks:S,staticGenerationAsyncStorage:M})}let D=a,j=i.a.wrap(y)}},e=>{var t=t=>e(e.s=t);e.O(0,[713],()=>t(1542));var o=e.O();(_ENTRIES="undefined"==typeof _ENTRIES?{}:_ENTRIES)["middleware_app/(site)/blog/[slug]/opengraph-image-fx5gi7/route"]=o}]);
