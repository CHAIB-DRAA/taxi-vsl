...
`}(e)}))];function c(){let e="https://www.taxi-31-toulouse.fr",t=new Date;return[{url:e,lastModified:t,changeFrequency:"weekly",priority:1},{url:`${e}/transport-medical`,lastModified:t,changeFrequency:"monthly",priority:.95},{url:`${e}/courses-privees`,lastModified:t,changeFrequency:"monthly",priority:.9},{url:`${e}/blog`,lastModified:t,changeFrequency:"weekly",priority:.85},{url:`${e}/a-propos`,lastModified:new Date("2026-05-17"),changeFrequency:"yearly",priority:.6},{url:`${e}/mentions-legales`,lastModified:new Date("2026-01-01"),changeFrequency:"yearly",priority:.2},{url:`${e}/politique-confidentialite`,lastModified:new Date("2026-01-01"),changeFrequency:"yearly",priority:.2},...d.map(t=>{let o=.7,n="monthly";switch(t.category){case"Guide":o=.9,n="monthly";break;case"H\xf4pitaux":case"Comparaisons":case"Sp\xe9cialit\xe9s":o=.85,n="monthly";break;case"Transport M\xe9dical":case"Courses Priv\xe9es":o=.8,n="monthly";break;case"Trajets":o=.75,n="monthly";break;case"Villes":o=.7,n="monthly"}return{url:`${e}/blog/${t.slug}`,lastModified:new Date(t.date),changeFrequency:n,priority:o}})].filter((e,t,o)=>t===o.findIndex(t=>t.url===e.url))}var x=o(707);let m={...n},v=m.default,g=m.generateSitemaps;if("function"!=typeof v)throw Error('Default export is missing in "/Users/mondz/Downloads/taxi-occitanie-project/src/app/sitemap.ts"');async function h(e,t){let o;let{__metadata_id__:n,...s}=t.params||{},a=g?await g():null;if(a&&null==(o=a.find(e=>{let t=e.id.toString();return(t+=".xml")===n})?.id))return new u.NextResponse("Not Found",{status:404});let i=await v({id:o}),r=(0,x.resolveRouteData)(i,"sitemap");return new u.NextResponse(r,{headers:{"Content-Type":"application/xml","Cache-Control":"public, max-age=0, must-revalidate"}})}let f=new a.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/sitemap.xml/route",pathname:"/sitemap.xml",filename:"sitemap",bundlePath:"app/sitemap.xml/route"},resolvedPagePath:"next-metadata-route-loader?page=%2Fsitemap.xml%2Froute&filePath=%2FUsers%2Fmondz%2FDownloads%2Ftaxi-occitanie-project%2Fsrc%2Fapp%2Fsitemap.ts&isDynamic=1!?__next_metadata_route__",nextConfigOutput:"",userland:s}),{requestAsyncStorage:b,staticGenerationAsyncStorage:q,serverHooks:T}=f,C="/sitemap.xml/route";function P(){return(0,r.patchFetch)({serverHooks:T,staticGenerationAsyncStorage:q})}},707:(e,t,o)=>{Object.defineProperty(t,"__esModule",{value:!0}),function(e,t){for(var o in t)Object.defineProperty(e,o,{enumerable:!0,get:t[o]})}(t,{resolveManifest:function(){return i},resolveRobots:function(){return s},resolveRouteData:function(){return r},resolveSitemap:function(){return a}});let n=o(1389);function s(e){let t="";for(let o of Array.isArray(e.rules)?e.rules:[e.rules]){for(let e of(0,n.resolveArray)(o.userAgent||["*"]))t+=`User-Agent: ${e}
`;if(o.allow)for(let e of(0,n.resolveArray)(o.allow))t+=`Allow: ${e}
`;if(o.disallow)for(let e of(0,n.resolveArray)(o.disallow))t+=`Disallow: ${e}
...
`}),t}function a(e){let t=e.some(e=>Object.keys(e.alternates??{}).length>0),o="";for(let s of(o+='<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"',t?o+=' xmlns:xhtml="http://www.w3.org/1999/xhtml">\n':o+=">\n",e)){var n;o+=`<url>
<loc>${s.url}</loc>
...
`),o+="</url>\n"}return o+"</urlset>\n"}function i(e){return JSON.stringify(e)}function r(e,t){return"robots"===t?s(e):"sitemap"===t?a(e):"manifest"===t?i(e):""}},1389:(e,t)=>{function o(e){return Array.isArray(e)?e:[e]}function n(e){if(null!=e)return o(e)}Object.defineProperty(t,"__esModule",{value:!0}),function(e,t){for(var o in t)Object.defineProperty(e,o,{enumerable:!0,get:t[o]})}(t,{resolveArray:function(){return o},resolveAsArrayOrUndefined:function(){return n}})}};var t=require("../../webpack-runtime.js");t.C(e);var o=e=>t(t.s=e),n=t.X(0,[948,518],()=>o(758));module.exports=n})();