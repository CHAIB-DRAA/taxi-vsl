...
`}(e)}))];var c=n(3988);function x(){let e=c.J.domain,t=new Date;return[{url:e,lastModified:t,changeFrequency:"weekly",priority:1},{url:`${e}/transport-medical`,lastModified:t,changeFrequency:"monthly",priority:1},{url:`${e}/courses-privees`,lastModified:t,changeFrequency:"monthly",priority:1},{url:`${e}/reserver`,lastModified:t,changeFrequency:"monthly",priority:1},{url:`${e}/tarifs`,lastModified:t,changeFrequency:"monthly",priority:.8},{url:`${e}/a-propos`,lastModified:new Date("2026-05-17"),changeFrequency:"yearly",priority:.8},{url:`${e}/blog`,lastModified:t,changeFrequency:"weekly",priority:.8},{url:`${e}/mentions-legales`,lastModified:new Date("2026-01-01"),changeFrequency:"yearly",priority:.2},{url:`${e}/politique-confidentialite`,lastModified:new Date("2026-01-01"),changeFrequency:"yearly",priority:.2},...d.map(t=>({url:`${e}/blog/${t.slug}`,lastModified:new Date(t.date),changeFrequency:"monthly",priority:.6}))].filter((e,t,n)=>t===n.findIndex(t=>t.url===e.url))}var m=n(707);let v={...o},g=v.default,h=v.generateSitemaps;if("function"!=typeof g)throw Error('Default export is missing in "/Users/mondz/Downloads/taxi-occitanie-project/src/app/sitemap.ts"');async function f(e,t){let n;let{__metadata_id__:o,...s}=t.params||{},a=h?await h():null;if(a&&null==(n=a.find(e=>{let t=e.id.toString();return(t+=".xml")===o})?.id))return new u.NextResponse("Not Found",{status:404});let i=await g({id:n}),r=(0,m.resolveRouteData)(i,"sitemap");return new u.NextResponse(r,{headers:{"Content-Type":"application/xml","Cache-Control":"public, max-age=0, must-revalidate"}})}let b=new a.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/sitemap.xml/route",pathname:"/sitemap.xml",filename:"sitemap",bundlePath:"app/sitemap.xml/route"},resolvedPagePath:"next-metadata-route-loader?page=%2Fsitemap.xml%2Froute&filePath=%2FUsers%2Fmondz%2FDownloads%2Ftaxi-occitanie-project%2Fsrc%2Fapp%2Fsitemap.ts&isDynamic=1!?__next_metadata_route__",nextConfigOutput:"",userland:s}),{requestAsyncStorage:T,staticGenerationAsyncStorage:q,serverHooks:C}=b,P="/sitemap.xml/route";function A(){return(0,r.patchFetch)({serverHooks:C,staticGenerationAsyncStorage:q})}},3988:(e,t,n)=>{n.d(t,{J:()=>o});let o={brand:{legalName:"OCCITANIE MEDI MOBILITY",shortName:"Taxi 31 Toulouse",displayName:"Taxi31Toulouse",highlight:"31",tagline:"Conventionn\xe9 CPAM",taglineAlt:"Conventionn\xe9 CPAM & Priv\xe9",cpamLabel:"Agr\xe9\xe9 CPAM Haute-Garonne"},domain:"https://www.taxi-31-toulouse.fr",contact:{phone:"0772339892",phoneDisplay:"07 72 33 98 92",phoneE164:"+33772339892",email:"contact@taxi-31-toulouse.fr",whatsapp:"https://wa.me/33772339892",smsBody:"Bonjour, je souhaite r\xe9server un taxi..."},address:{street:"6 rue Buissonni\xe8re Bat A",city:"Fonbeauzard",postalCode:"31140",region:"Haute-Garonne",country:"FR",display:"Toulouse & Occitanie",displaySub:"Haute-Garonne (31)"},geo:{lat:"43.6843",lng:"1.4230",metaRegion:"FR-OCC",metaCity:"Toulouse",metaPosition:"43.6047;1.4442",metaICBM:"43.6047, 1.4442"},google:{adsId:"AW-17844653906",searchConsole:"ETCwhGEYjo9LoL4TK82q9VWvXsOc5TTg8gg0WJzOZI",cid:"15905025186406049849",mapsUrl:"https://maps.google.com/?cid=15905025186406049849",reviewUrl:"https://g.page/r/Cbh2nxTvVS7cEBM/review",sameAsGPage:"https://g.page/r/Cbh2nxTvVS7cEAE"},seo:{title:"Taxi Conventionn\xe9 CPAM Toulouse | Transport M\xe9dical & Courses Priv\xe9es",titleTemplate:"%s | Taxi 31 Toulouse — Occitanie M\xe9di Mobility",description:"Taxi VSL conventionn\xe9 CPAM \xe0 Toulouse et en Occitanie. Transport m\xe9dical (dialyse, chimioth\xe9rapie, ALD) avec tiers payant int\xe9gral — 0€ d'avance. Courses priv\xe9es : A\xe9roport Blagnac, Gare Matabiau, \xe9v\xe9nements. Disponible 24h/24.",ogTitle:"Taxi Conventionn\xe9 CPAM Toulouse — Occitanie M\xe9di Mobility",ogDescription:"Transport m\xe9dical VSL rembours\xe9 CPAM (dialyse, chimio, ALD) et courses priv\xe9es (a\xe9roport, gare, mariages) \xe0 Toulouse et en Occitanie. Tiers payant int\xe9gral — 0€ d'avance.",twitterTitle:"Taxi Conventionn\xe9 CPAM Toulouse — Occitanie M\xe9di Mobility",twitterDescription:"Transport m\xe9dical VSL et courses priv\xe9es \xe0 Toulouse. Tiers payant int\xe9gral, 0€ d'avance. Disponible 24h/24.",localBusinessName:"Taxi Conventionn\xe9 CPAM Toulouse — Occitanie M\xe9di Mobility",localBusinessDescription:"Taxi conventionn\xe9 CPAM et VSL en Occitanie. Transport m\xe9dical assis (ALD, chimioth\xe9rapie, dialyse, radioth\xe9rapie) avec tiers payant int\xe9gral — 0€ d'avance. Courses priv\xe9es : a\xe9roport Toulouse-Blagnac, gare Matabiau, mariages, \xe9v\xe9nements. Disponible 24h/24."},cities31:["Toulouse","Muret","Colomiers","Tournefeuille","Blagnac","Plaisance-du-Touch","Cugnaux","Balma","Ramonville-Saint-Agne","Castanet-Tolosan","Fonsorbes","L'Union","Saint-Orens-de-Gameville","Saint-Jean","Castelginest","Portet-sur-Garonne","Auterive","Revel","Saint-Lys","L\xe9guevin","Frouzins","Grenade","Aussonne","Cornebarrieu","Launaguet","Aucamville","Fronton","Villemur-sur-Tarn","Beauzelle","Brugui\xe8res","Fenouillet","Saint-Jory","Gratentour","Montastruc-la-Conseill\xe8re","Verfeil","Carbonne","Caz\xe8res","Rieumes","Seysses","Eaunes","Labarthe-sur-L\xe8ze","Pins-Justaret","Roques","Saubens","Mondonville","Pibrac","Brax","Lherm","Lab\xe8ge","Escalquens","Lanta","Caraman","Nailloux","Villefranche-de-Lauragais","Montgiscard","L'Isle-Jourdain","Cintegabelle","Rieux-Volvestre"],regionalCities:["Pamiers","Foix","Saint-Girons","Albi","Castres","Montauban","Auch","Tarbes","Cahors","Carcassonne","Rodez","Millau","Mende","Figeac","Lourdes","Narbonne"]}},707:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),function(e,t){for(var n in t)Object.defineProperty(e,n,{enumerable:!0,get:t[n]})}(t,{resolveManifest:function(){return i},resolveRobots:function(){return s},resolveRouteData:function(){return r},resolveSitemap:function(){return a}});let o=n(1389);function s(e){let t="";for(let n of Array.isArray(e.rules)?e.rules:[e.rules]){for(let e of(0,o.resolveArray)(n.userAgent||["*"]))t+=`User-Agent: ${e}
`;if(n.allow)for(let e of(0,o.resolveArray)(n.allow))t+=`Allow: ${e}
`;if(n.disallow)for(let e of(0,o.resolveArray)(n.disallow))t+=`Disallow: ${e}
`;n.crawlDelay&&(t+=`Crawl-delay: ${n.crawlDelay}
`),t+="\n"}return e.host&&(t+=`Host: ${e.host}
`),e.sitemap&&(0,o.resolveArray)(e.sitemap).forEach(e=>{t+=`Sitemap: ${e}
`}),t}function a(e){let t=e.some(e=>Object.keys(e.alternates??{}).length>0),n="";for(let s of(n+='<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"',t?n+=' xmlns:xhtml="http://www.w3.org/1999/xhtml">\n':n+=">\n",e)){var o;n+=`<url>
<loc>${s.url}</loc>
...
`),n+="</url>\n"}return n+"</urlset>\n"}function i(e){return JSON.stringify(e)}function r(e,t){return"robots"===t?s(e):"sitemap"===t?a(e):"manifest"===t?i(e):""}},1389:(e,t)=>{function n(e){return Array.isArray(e)?e:[e]}function o(e){if(null!=e)return n(e)}Object.defineProperty(t,"__esModule",{value:!0}),function(e,t){for(var n in t)Object.defineProperty(e,n,{enumerable:!0,get:t[n]})}(t,{resolveArray:function(){return n},resolveAsArrayOrUndefined:function(){return o}})}};var t=require("../../webpack-runtime.js");t.C(e);var n=e=>t(t.s=e),o=t.X(0,[948,518],()=>n(758));module.exports=o})();