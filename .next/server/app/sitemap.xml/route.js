...
`}(e)}))];function c(){let e="https://www.taxi-31-toulouse.fr",o=new Date;return[{url:e,lastModified:o,changeFrequency:"weekly",priority:1},{url:`${e}/transport-medical`,lastModified:o,changeFrequency:"monthly",priority:.95},{url:`${e}/courses-privees`,lastModified:o,changeFrequency:"monthly",priority:.9},{url:`${e}/blog`,lastModified:o,changeFrequency:"weekly",priority:.85},{url:`${e}/a-propos`,lastModified:new Date("2026-05-17"),changeFrequency:"yearly",priority:.6},{url:`${e}/mentions-legales`,lastModified:new Date("2026-01-01"),changeFrequency:"yearly",priority:.2},{url:`${e}/politique-confidentialite`,lastModified:new Date("2026-01-01"),changeFrequency:"yearly",priority:.2},...d.map(o=>{let n=.7,a="monthly";switch(o.category){case"Guide":n=.9,a="monthly";break;case"H\xf4pitaux":n=.85,a="monthly";break;case"Transport M\xe9dical":case"Courses Priv\xe9es":n=.8,a="monthly";break;case"Trajets":n=.75,a="monthly";break;case"Villes":n=.7,a="monthly"}return{url:`${e}/blog/${o.slug}`,lastModified:new Date(o.date),changeFrequency:a,priority:n}})].filter((e,o,n)=>o===n.findIndex(o=>o.url===e.url))}var m=n(707);let x={...a},g=x.default,v=x.generateSitemaps;if("function"!=typeof g)throw Error('Default export is missing in "/Users/mondz/Downloads/taxi-occitanie-project/src/app/sitemap.ts"');async function h(e,o){let n;let{__metadata_id__:a,...t}=o.params||{},s=v?await v():null;if(s&&null==(n=s.find(e=>{let o=e.id.toString();return(o+=".xml")===a})?.id))return new u.NextResponse("Not Found",{status:404});let r=await g({id:n}),i=(0,m.resolveRouteData)(r,"sitemap");return new u.NextResponse(i,{headers:{"Content-Type":"application/xml","Cache-Control":"public, max-age=0, must-revalidate"}})}let f=new s.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/sitemap.xml/route",pathname:"/sitemap.xml",filename:"sitemap",bundlePath:"app/sitemap.xml/route"},resolvedPagePath:"next-metadata-route-loader?page=%2Fsitemap.xml%2Froute&filePath=%2FUsers%2Fmondz%2FDownloads%2Ftaxi-occitanie-project%2Fsrc%2Fapp%2Fsitemap.ts&isDynamic=1!?__next_metadata_route__",nextConfigOutput:"",userland:t}),{requestAsyncStorage:T,staticGenerationAsyncStorage:b,serverHooks:q}=f,C="/sitemap.xml/route";function P(){return(0,i.patchFetch)({serverHooks:q,staticGenerationAsyncStorage:b})}},707:(e,o,n)=>{Object.defineProperty(o,"__esModule",{value:!0}),function(e,o){for(var n in o)Object.defineProperty(e,n,{enumerable:!0,get:o[n]})}(o,{resolveManifest:function(){return r},resolveRobots:function(){return t},resolveRouteData:function(){return i},resolveSitemap:function(){return s}});let a=n(1389);function t(e){let o="";for(let n of Array.isArray(e.rules)?e.rules:[e.rules]){for(let e of(0,a.resolveArray)(n.userAgent||["*"]))o+=`User-Agent: ${e}
`;if(n.allow)for(let e of(0,a.resolveArray)(n.allow))o+=`Allow: ${e}
`;if(n.disallow)for(let e of(0,a.resolveArray)(n.disallow))o+=`Disallow: ${e}
`;n.crawlDelay&&(o+=`Crawl-delay: ${n.crawlDelay}
`),o+="\n"}return e.host&&(o+=`Host: ${e.host}
`),e.sitemap&&(0,a.resolveArray)(e.sitemap).forEach(e=>{o+=`Sitemap: ${e}
`}),o}function s(e){let o=e.some(e=>Object.keys(e.alternates??{}).length>0),n="";for(let t of(n+='<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"',o?n+=' xmlns:xhtml="http://www.w3.org/1999/xhtml">\n':n+=">\n",e)){var a;n+=`<url>
<loc>${t.url}</loc>
`;let e=null==(a=t.alternates)?void 0:a.languages;if(e&&Object.keys(e).length)for(let o in e)n+=`<xhtml:link rel="alternate" hreflang="${o}" href="${e[o]}" />
`;if(t.lastModified){let e=t.lastModified instanceof Date?t.lastModified.toISOString():t.lastModified;n+=`<lastmod>${e}</lastmod>
`}t.changeFrequency&&(n+=`<changefreq>${t.changeFrequency}</changefreq>
`),"number"==typeof t.priority&&(n+=`<priority>${t.priority}</priority>
`),n+="</url>\n"}return n+"</urlset>\n"}function r(e){return JSON.stringify(e)}function i(e,o){return"robots"===o?t(e):"sitemap"===o?s(e):"manifest"===o?r(e):""}},1389:(e,o)=>{function n(e){return Array.isArray(e)?e:[e]}function a(e){if(null!=e)return n(e)}Object.defineProperty(o,"__esModule",{value:!0}),function(e,o){for(var n in o)Object.defineProperty(e,n,{enumerable:!0,get:o[n]})}(o,{resolveArray:function(){return n},resolveAsArrayOrUndefined:function(){return a}})}};var o=require("../../webpack-runtime.js");o.C(e);var n=e=>o(o.s=e),a=o.X(0,[948,518],()=>n(758));module.exports=a})();